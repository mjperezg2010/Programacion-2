 ...
 * @author mjper
 */
  public class AlfilB extends Pieza {
    public AlfilB() {
        super("Alfil", "Blancas");
    }
    ...
    public boolean escoger(char[][] t, int i1, int j1) {
        ...
        //Esquinas
        if (i1 == 0 && j1 == 0) {
            if ((t[i1 + 1][j1 + 1] != '♜' && t[i1 + 1][j1 + 1] != '♞' && t[i1 + 1][j1 + 1] != '♛' && t[i1 + 1][j1 + 1] != '♚' && t[i1 + 1][j1 + 1] != '♟' && t[i1 + 1][j1 + 1] != '⛝'&& t[i1 + 1][j1 + 1] != '♝')) {
            ...
            if ((t[i1 + 1][j1 + 1] != '♜' && t[i1 + 1][j1 + 1] != '♞' && t[i1 + 1][j1 + 1] != '♛' && t[i1 + 1][j1 + 1] != '♚' && t[i1 + 1][j1 + 1] != '♟' && t[i1 + 1][j1 + 1] != '⛝'&& t[i1 + 1][j1 + 1] != '♝')
                    && (t[i1 + 1][j1 - 1] != '♜' && t[i1 + 1][j1 - 1] != '♞' && t[i1 + 1][j1 - 1] != '♛' && t[i1 + 1][j1 - 1] != '♚' && t[i1 + 1][j1 - 1] != '♟' && t[i1 + 1][j1 - 1] != '⛝'&& t[i1 + 1][j1 - 1] != '♝')) {
                JOptionPane.showMessageDialog(null, "No puede mover esta pieza", "Advertencia", JOptionPane.WARNING_MESSAGE);
                aux = true;
